 ...
 *
 *         void MtrTrq(double u1, double u2, double u3, double u4, double u5, double u6, double y1[1], double y2[1])
 *
 *    Simulink version           : 23.2 (R2023b) 01-Aug-2023
 *    C source code generated on : 18-Nov-2023 00:52:03
 *
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "MtrTrq", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
    } /* if */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    MtrTrq(*u1, *u2, *u3, *u4, *u5, *u6, y1, y2);
}
