...
#define S_FUNCTION_NAME BattHevP4_msf
#endif
...
static void mdlInitializeConditions ( SimStruct * S ) { fc1yykdatze * dw = (
fc1yykdatze * ) ssGetDWork ( S , 0 ) ; nzo4ptcd4i * localX = ( nzo4ptcd4i * )
ssGetContStates ( S ) ; eeevvys3rt ( & ( dw -> rtm ) , & ( dw -> rtdw ) ,
localX ) ; } static void mdlReset ( SimStruct * S ) { fc1yykdatze * dw = (
fc1yykdatze * ) ssGetDWork ( S , 0 ) ; nzo4ptcd4i * localX = ( nzo4ptcd4i * )
ssGetContStates ( S ) ; b0rwgxz4xm ( & ( dw -> rtm ) , & ( dw -> rtdw ) ,
localX ) ; } static void mdlPeriodicOutputUpdate ( SimStruct * S , int_T tid
) { fc1yykdatze * dw = ( fc1yykdatze * ) ssGetDWork ( S , 0 ) ; real_T const
* i_ejm2gd1vg1 = ( real_T * ) ssGetInputPortSignal ( S , 0 ) ; real_T const *
i_p3zgdtey2n = ( real_T * ) ssGetInputPortSignal ( S , 1 ) ; real_T * o_B_6_1
= ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; real_T * o_B_6_2 = ( real_T
* ) ssGetOutputPortSignal ( S , 1 ) ; real_T * o_B_6_3 = ( real_T * )
ssGetOutputPortSignal ( S , 2 ) ; real_T * o_B_6_4 = ( real_T * )
ssGetOutputPortSignal ( S , 3 ) ; nzo4ptcd4i * localX = ( nzo4ptcd4i * )
ssGetContStates ( S ) ; if ( tid == 0 ) { BattHevP4 ( & ( dw -> rtm ) ,
i_ejm2gd1vg1 , i_p3zgdtey2n , o_B_6_1 , o_B_6_2 , o_B_6_3 , o_B_6_4 , & ( dw
-> rtb ) , & ( dw -> rtdw ) , localX ) ; enrfi3fbq1 ( & ( dw -> rtdw ) ) ; }
...
2 , 4 ) ; if ( ! ssSetNumInputPorts ( S , 2 ) ) return ; if ( !
...
( S , 1 , 0.0 ) ; if ( ! ssSetNumOutputPorts ( S , 4 ) ) return ; if ( !
...
mr_BattHevP4_RegisterSimStateChecksum ( S ) ; ssSetNumSampleTimes ( S , 3 ) ;
...
SS_SIMMODE_SIZES_CALL_ONLY ) { int_T retVal = 1 ; mr_BattHevP4_MdlInfoRegFcn
( S , "BattHevP4" , & retVal ) ; if ( ! retVal ) return ; }
#endif
#if SS_SFCN_FOR_SIM
if ( ssSetNumDWork ( S , 1 ) ) { int mdlrefDWTypeId ; ssRegMdlRefDWorkType (
S , & mdlrefDWTypeId ) ; if ( mdlrefDWTypeId == INVALID_DTYPE_ID ) return ;
if ( ! ssSetDataTypeSize ( S , mdlrefDWTypeId , sizeof ( fc1yykdatze ) ) )
...
static void mdlSetupRuntimeResources ( SimStruct * S ) { fc1yykdatze * dw = (
fc1yykdatze * ) ssGetDWork ( S , 0 ) ; nzo4ptcd4i * localX = ( nzo4ptcd4i * )
ssGetContStates ( S ) ; void * sysRanPtr = ( NULL ) ; int sysTid = 0 ;
ssGetContextSysRanBCPtr ( S , & sysRanPtr ) ; ssGetContextSysTid ( S , &
sysTid ) ; if ( sysTid == CONSTANT_TID ) { sysTid = 0 ; } ermomkkhlx ( S ,
...
* S , int_T tid ) { fc1yykdatze * dw = ( fc1yykdatze * ) ssGetDWork ( S , 0 )
; real_T const * i_ejm2gd1vg1 = ( real_T * ) ssGetInputPortSignal ( S , 0 ) ;
real_T const * i_p3zgdtey2n = ( real_T * ) ssGetInputPortSignal ( S , 1 ) ;
real_T * o_B_6_1 = ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; real_T *
o_B_6_2 = ( real_T * ) ssGetOutputPortSignal ( S , 1 ) ; real_T * o_B_6_3 = (
real_T * ) ssGetOutputPortSignal ( S , 2 ) ; real_T * o_B_6_4 = ( real_T * )
ssGetOutputPortSignal ( S , 3 ) ; nzo4ptcd4i * localX = ( nzo4ptcd4i * )
ssGetContStates ( S ) ; if ( tid == PARAMETER_TUNING_TID ) { BattHevP4TID2 (
& ( dw -> rtb ) ) ; } if ( tid != CONSTANT_TID && tid != PARAMETER_TUNING_TID
) { if ( ssIsSampleHit ( S , 0 , tid ) || ssIsMinorTimeStep ( S ) ) {
BattHevP4 ( & ( dw -> rtm ) , i_ejm2gd1vg1 , i_p3zgdtey2n , o_B_6_1 , o_B_6_2
, o_B_6_3 , o_B_6_4 , & ( dw -> rtb ) , & ( dw -> rtdw ) , localX ) ; } } }
#define MDL_UPDATE
static void mdlUpdate ( SimStruct * S , int_T tid ) { fc1yykdatze * dw = (
fc1yykdatze * ) ssGetDWork ( S , 0 ) ; enrfi3fbq1 ( & ( dw -> rtdw ) ) ;
return ; }
#define MDL_DERIVATIVES
static void mdlDerivatives ( SimStruct * S ) { fc1yykdatze * dw = (
fc1yykdatze * ) ssGetDWork ( S , 0 ) ; nzo4ptcd4i * localX = ( nzo4ptcd4i * )
ssGetContStates ( S ) ; kuejxqaigs * localXdot = ( kuejxqaigs * ) ssGetdX ( S
) ; doej41yld0 ( & ( dw -> rtb ) , localX , localXdot ) ; } static void
mdlTerminate ( SimStruct * S ) { fc1yykdatze * dw = ( fc1yykdatze * )
ssGetDWork ( S , 0 ) ; d51nt2wcq4 ( & ( dw -> rtm ) ) ; return ; }
...
mxCreateStructMatrix ( 1 , 1 , 6 , simStateFieldNames ) ; { const nzo4ptcd4i
* localX = ( const nzo4ptcd4i * ) ssGetContStates ( S ) ; const size_t
numBytes = sizeof ( nzo4ptcd4i ) ; mxArray * storedX = mxCreateNumericMatrix
...
mr_BattHevP4_GetDWork ( ssGetDWork ( S , 0 ) ) ; mxSetFieldByNumber ( ss , 0
, 1 , mdlrefDW ) ; } { mxArray * data =
mr_BattHevP4_GetSimStateDisallowedBlocks ( ) ; mxSetFieldByNumber ( ss , 0 ,
...
nzo4ptcd4i * localX = ( nzo4ptcd4i * ) ssGetContStates ( S ) ; const size_t
numBytes = sizeof ( nzo4ptcd4i ) ; const mxArray * storedX =
mxGetFieldByNumber ( ss , 0 , 0 ) ; const UINT8_T * rawData = ( const UINT8_T
* ) mxGetData ( storedX ) ; memcpy ( localX , & rawData [ 0 ] , numBytes ) ;
} mr_BattHevP4_SetDWork ( ssGetDWork ( S , 0 ) , mxGetFieldByNumber ( ss , 0
