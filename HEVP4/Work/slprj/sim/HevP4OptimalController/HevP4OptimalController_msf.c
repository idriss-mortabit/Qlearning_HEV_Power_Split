...
#define S_FUNCTION_NAME HevP4OptimalController_msf
#endif
...
#endif
static void mdlInitializeConditions ( SimStruct * S ) { jaycrc4s13t * dw = (
jaycrc4s13t * ) ssGetDWork ( S , 0 ) ; real_T * o_o_B_31_1 = ( real_T * )
ssGetOutputPortSignal ( S , 0 ) ; real_T * o_o_B_31_2 = ( real_T * )
ssGetOutputPortSignal ( S , 1 ) ; jwsgs15ojz ( o_o_B_31_1 , o_o_B_31_2 , & (
dw -> rtdw ) ) ; } static void mdlReset ( SimStruct * S ) { jaycrc4s13t * dw
= ( jaycrc4s13t * ) ssGetDWork ( S , 0 ) ; d43qhbwhjy ( & ( dw -> rtdw ) ) ;
} static void mdlPeriodicOutputUpdate ( SimStruct * S , int_T tid ) {
jaycrc4s13t * dw = ( jaycrc4s13t * ) ssGetDWork ( S , 0 ) ; real_T const *
i_gdekboalmv = ( real_T * ) ssGetInputPortSignal ( S , 0 ) ; real_T const *
i_l0ptew40x3 = ( real_T * ) ssGetInputPortSignal ( S , 1 ) ; real_T const *
i_frwewjijdh = ( real_T * ) ssGetInputPortSignal ( S , 2 ) ; real_T const *
i_jlgxblg5se = ( real_T * ) ssGetInputPortSignal ( S , 3 ) ; real_T const *
i_mdxtgt22sn = ( real_T * ) ssGetInputPortSignal ( S , 4 ) ; real_T const *
i_lau23taw5g = ( real_T * ) ssGetInputPortSignal ( S , 5 ) ; real_T const *
i_clohu0yyjq = ( real_T * ) ssGetInputPortSignal ( S , 6 ) ; real_T *
o_o_B_31_1 = ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; real_T *
o_o_B_31_2 = ( real_T * ) ssGetOutputPortSignal ( S , 1 ) ; real_T * o_B_31_3
= ( real_T * ) ssGetOutputPortSignal ( S , 2 ) ; real_T * o_B_31_4 = ( real_T
* ) ssGetOutputPortSignal ( S , 3 ) ; real_T * o_B_31_5 = ( real_T * )
ssGetOutputPortSignal ( S , 4 ) ; real_T * o_B_31_6 = ( real_T * )
ssGetOutputPortSignal ( S , 5 ) ; real_T * o_B_31_7 = ( real_T * )
ssGetOutputPortSignal ( S , 6 ) ; real_T * o_B_31_8 = ( real_T * )
ssGetOutputPortSignal ( S , 7 ) ; real_T * o_B_31_9 = ( real_T * )
ssGetOutputPortSignal ( S , 8 ) ; if ( tid == 0 ) { HevP4OptimalController (
& ( dw -> rtm ) , i_gdekboalmv , i_l0ptew40x3 , i_frwewjijdh , i_jlgxblg5se ,
i_mdxtgt22sn , i_lau23taw5g , i_clohu0yyjq , o_o_B_31_1 , o_o_B_31_2 ,
o_B_31_3 , o_B_31_4 , o_B_31_5 , o_B_31_6 , o_B_31_7 , o_B_31_8 , o_B_31_9 ,
& ( dw -> rtb ) , & ( dw -> rtdw ) ) ; bnwzenvtha ( & ( dw -> rtb ) , & ( dw
...
slmrInitializeIOPortDataVectors ( S , 8 , 9 ) ; if ( ! ssSetNumInputPorts ( S
...
ssSetInputPortOffsetTime ( S , 7 , 0.0 ) ; if ( ! ssSetNumOutputPorts ( S , 9
...
mr_HevP4OptimalController_RegisterSimStateChecksum ( S ) ;
...
false ) ; ssRegisterMsgForNotSupportingMultiExecInst ( S ,
 "<diag_root><diag id=\"Simulink:blocks:UserSFcnBlockDoesNotSupportMultiExecInstances\" pr=\"d\"><arguments><arg type=\"encoded\">SABlAHYAUAA0AE8AcAB0AGkAbQBhAGwAQwBvAG4AdAByAG8AbABsAGUAcgAvAFMALQBGAHUAbgBjAHQAaQBvAG4AMgAAAA==</arg><arg type=\"encoded\">PABfAF8AaQBpAFMAUwBfAF8APgA8AC8AXwBfAGkAaQBTAFMAXwBfAD4AAAA=</arg><arg type=\"encoded\">PABfAF8AaQB0AGUAcgBCAGwAawBfAF8APgA8AC8AXwBfAGkAdABlAHIAQgBsAGsAXwBfAD4AAAA=</arg></arguments><hs><h>AAAAAgBz6UBb</h></hs></diag></diag_root>"
...
mr_HevP4OptimalController_MdlInfoRegFcn ( S , "HevP4OptimalController" , &
retVal ) ; if ( ! retVal ) return ; }
#endif
#if SS_SFCN_FOR_SIM
if ( ssSetNumDWork ( S , 1 ) ) { int mdlrefDWTypeId ; ssRegMdlRefDWorkType (
S , & mdlrefDWTypeId ) ; if ( mdlrefDWTypeId == INVALID_DTYPE_ID ) return ;
if ( ! ssSetDataTypeSize ( S , mdlrefDWTypeId , sizeof ( jaycrc4s13t ) ) )
...
static void mdlSetupRuntimeResources ( SimStruct * S ) { jaycrc4s13t * dw = (
jaycrc4s13t * ) ssGetDWork ( S , 0 ) ; void * sysRanPtr = ( NULL ) ; int
sysTid = 0 ; ssGetContextSysRanBCPtr ( S , & sysRanPtr ) ; ssGetContextSysTid
( S , & sysTid ) ; if ( sysTid == CONSTANT_TID ) { sysTid = 0 ; } iiwxpwj3gt
...
-> mdlInfo -> genericFcn ; } }
#define MDL_START
static void mdlStart ( SimStruct * S ) { jaycrc4s13t * dw = ( jaycrc4s13t * )
ssGetDWork ( S , 0 ) ; fuersghdre ( & ( dw -> rtdw ) ) ; }
#define RTW_GENERATED_DISABLE
static void mdlDisable ( SimStruct * S ) { jaycrc4s13t * dw = ( jaycrc4s13t *
) ssGetDWork ( S , 0 ) ; bk11av3lhi ( & ( dw -> rtm ) , & ( dw -> rtdw ) ) ;
return ; } static void mdlOutputs ( SimStruct * S , int_T tid ) { jaycrc4s13t
* dw = ( jaycrc4s13t * ) ssGetDWork ( S , 0 ) ; real_T const * i_gdekboalmv =
( real_T * ) ssGetInputPortSignal ( S , 0 ) ; real_T const * i_l0ptew40x3 = (
real_T * ) ssGetInputPortSignal ( S , 1 ) ; real_T const * i_frwewjijdh = (
real_T * ) ssGetInputPortSignal ( S , 2 ) ; real_T const * i_jlgxblg5se = (
real_T * ) ssGetInputPortSignal ( S , 3 ) ; real_T const * i_mdxtgt22sn = (
real_T * ) ssGetInputPortSignal ( S , 4 ) ; real_T const * i_lau23taw5g = (
real_T * ) ssGetInputPortSignal ( S , 5 ) ; real_T const * i_clohu0yyjq = (
real_T * ) ssGetInputPortSignal ( S , 6 ) ; real_T * o_o_B_31_1 = ( real_T *
) ssGetOutputPortSignal ( S , 0 ) ; real_T * o_o_B_31_2 = ( real_T * )
ssGetOutputPortSignal ( S , 1 ) ; real_T * o_B_31_3 = ( real_T * )
ssGetOutputPortSignal ( S , 2 ) ; real_T * o_B_31_4 = ( real_T * )
ssGetOutputPortSignal ( S , 3 ) ; real_T * o_B_31_5 = ( real_T * )
ssGetOutputPortSignal ( S , 4 ) ; real_T * o_B_31_6 = ( real_T * )
ssGetOutputPortSignal ( S , 5 ) ; real_T * o_B_31_7 = ( real_T * )
ssGetOutputPortSignal ( S , 6 ) ; real_T * o_B_31_8 = ( real_T * )
ssGetOutputPortSignal ( S , 7 ) ; real_T * o_B_31_9 = ( real_T * )
ssGetOutputPortSignal ( S , 8 ) ; if ( tid == PARAMETER_TUNING_TID ) {
HevP4OptimalControllerTID1 ( & ( dw -> rtb ) ) ; } if ( tid != CONSTANT_TID
&& tid != PARAMETER_TUNING_TID ) { HevP4OptimalController ( & ( dw -> rtm ) ,
i_gdekboalmv , i_l0ptew40x3 , i_frwewjijdh , i_jlgxblg5se , i_mdxtgt22sn ,
i_lau23taw5g , i_clohu0yyjq , o_o_B_31_1 , o_o_B_31_2 , o_B_31_3 , o_B_31_4 ,
o_B_31_5 , o_B_31_6 , o_B_31_7 , o_B_31_8 , o_B_31_9 , & ( dw -> rtb ) , & (
dw -> rtdw ) ) ; } }
#define MDL_UPDATE
static void mdlUpdate ( SimStruct * S , int_T tid ) { jaycrc4s13t * dw = (
jaycrc4s13t * ) ssGetDWork ( S , 0 ) ; bnwzenvtha ( & ( dw -> rtb ) , & ( dw
-> rtdw ) ) ; return ; } static void mdlTerminate ( SimStruct * S ) {
jaycrc4s13t * dw = ( jaycrc4s13t * ) ssGetDWork ( S , 0 ) ; ioun3a0d3c ( & (
dw -> rtm ) ) ; return ; }
...
mdlrefDW = mr_HevP4OptimalController_GetDWork ( ssGetDWork ( S , 0 ) ) ;
mxSetFieldByNumber ( ss , 0 , 1 , mdlrefDW ) ; } { mxArray * data =
mr_HevP4OptimalController_GetSimStateDisallowedBlocks ( ) ;
...
mr_HevP4OptimalController_SetDWork ( ssGetDWork ( S , 0 ) ,
