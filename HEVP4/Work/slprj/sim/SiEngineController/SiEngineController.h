...
#include <stddef.h>
typedef struct { real_T n5u3wxcqhl ; real_T lrjamc5jzb ; real_T ox23kmdvx3 ;
real_T kucvdppv5m ; real_T ac1oey0nij ; real_T c1xgcekagw ; real_T jy2vjzgbs4
; real_T hfeqi2lyr5 ; real_T l32jdllewl ; real_T jiqsyszgk4 ; real_T
h1x4m00uba ; real_T nc1mmdlp0a ; } k2iermqa3e ; typedef struct { real_T
bululxmkr4 ; real_T mdpnsozbp5 ; real_T dhcatcjv33 ; real_T fqln1ajymu ;
...
real_T P_122 ; real_T P_123 [ 2 ] ; real_T P_124 [ 2 ] ; real_T P_125 ;
...
real_T P_136 ; real_T P_137 ; real_T P_138 ; real_T P_139 [ 2 ] ; real_T
P_140 [ 2 ] ; real_T P_141 [ 3 ] ; real_T P_142 [ 3 ] ; real_T P_143 ; real_T
...
P_164 ; real_T P_165 ; real_T P_166 ; uint32_T P_167 [ 2 ] ; uint32_T P_168 [
2 ] ; uint32_T P_169 [ 2 ] ; uint32_T P_170 [ 2 ] ; uint32_T P_171 [ 2 ] ;
uint32_T P_172 [ 2 ] ; uint32_T P_173 [ 2 ] ; uint32_T P_174 [ 2 ] ; uint32_T
P_175 [ 2 ] ; uint32_T P_176 [ 2 ] ; uint32_T P_177 [ 2 ] ; uint32_T P_178 [
2 ] ; uint32_T P_179 [ 2 ] ; boolean_T P_180 ; } ; struct mvxg2sjgqu { struct
...
localB , co1aiayk40 * localDW ) ; extern void SiEngineController ( fjokl4fytp
* const hxsxflkffh , const real_T * dsupzrhvju , const real_T * kdqsy4qvj4 ,
const real_T * gl4kax2uwh , const real_T * plu5o4vwms , const real_T *
dtnj3mqbfl , const real_T * essrlj514x , const real_T * nv5lv0jtvq , const
real_T * hkryo4lax0 , const real_T * aqk2ykobp0 , const boolean_T *
pk3jgu2pjk , const real_T * b3nwekvxwf , const real_T * b10xhuopqf , const
real_T * odwxlya4wd , const real_T * jezyuuj3xd , real_T * ek4dh2lsrg ,
real_T * baf2pre153 , real_T * a4uwrlxka2 , real_T * fbeaxzhi0h , real_T *
fgda0i4ghp , real_T * pbn5xgwgh5 , real_T * apvhdbbt3m , real_T * ifqkan4qqd
, real_T * iix0kvfk5x , real_T * hwjb1qnl3t , real_T * ijtb1vna2r , real_T *
nywrh2lh1n , real_T * gdv5b2pyyy , real_T * db42qklkzd , real_T * jpy4qtlq32
, real_T * eoxvxtbeup , real_T * mnqgcjowd4 , k2iermqa3e * localB ,
co1aiayk40 * localDW ) ; extern void SiEngineControllerTID1 ( k2iermqa3e *
localB , co1aiayk40 * localDW ) ; extern void kbxp3i41oa ( fjokl4fytp * const
hxsxflkffh ) ;
#endif
