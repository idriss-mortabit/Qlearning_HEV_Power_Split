...
TARGET_STRING ( "SiMappedEngine/Electronic Throttle Actuator Dynamics" ) ,
TARGET_STRING ( "" ) , TARGET_STRING ( "" ) , 0 , 0 , 0 , 0 , 0 , 1 , - 1 , 0
} , { 1 , 0 , TARGET_STRING (
"SiMappedEngine/Accessory Load Model/Lumped Torque Dynamics" ) ,
TARGET_STRING ( "" ) , TARGET_STRING ( "" ) , 0 , 0 , 0 , 0 , 0 , 1 , - 1 , 0
} , { 2 , 9 , TARGET_STRING ( "SiMappedEngine/Actuators/EGR Valve Dynamics" )
...
1 , 0 } } ; static int_T rt_LoggedStateIdxList [ ] = { 1 , 0 , 9 , 4 , 7 , 6
, 13 , 8 , 10 , 12 , 11 , 5 , 3 , 2 } ;
...
{ 556699696U , 2292472135U , 2904349425U , 3371475529U } , &
