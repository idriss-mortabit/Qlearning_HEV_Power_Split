...
MODEL                   = rtwshared
MODULES                 = look1_binlcapw.c look2_binlcapw.c rtGetInf.c rtGetNaN.c rt_nonfinite.c automldiffopen_ujNuWwNk.c binsearch_u32d.c binsearch_u32d_prevIdx.c interp2_Dz8B5aYN.c intrp1d_la_pw.c intrp4d_l_pw.c look1_binlcpw.c look1_binlxpw.c plook_binc.c plook_bincpa.c plook_u32d_binckan.c rt_zcfcn.c intrp2d_la_pw.c plook_binca.c BINARYSEARCH_real_T.c LookUp_real_T_real_T.c getExpmParams_wY8zD8EB.c intrp3d_l_pw.c log2_88lh625s.c look1_pbinlcapw.c look2_binlcpw.c norm_doJDoZY6.c recomputeBlockDiag_jaPUPAO1.c xhseqr_9pzSUODQ.c
