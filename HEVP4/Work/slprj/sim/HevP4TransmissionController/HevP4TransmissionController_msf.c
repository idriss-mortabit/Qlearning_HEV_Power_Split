...
#define S_FUNCTION_NAME HevP4TransmissionController_msf
#endif
...
static void mdlInitializeConditions ( SimStruct * S ) { fjvy5vdomkr * dw = (
fjvy5vdomkr * ) ssGetDWork ( S , 0 ) ; real_T * o_o_o_B_5_1 = ( real_T * )
ssGetOutputPortSignal ( S , 0 ) ; kpvk0y2dwm ( o_o_o_B_5_1 , & ( dw -> rtdw )
) ; } static void mdlReset ( SimStruct * S ) { fjvy5vdomkr * dw = (
fjvy5vdomkr * ) ssGetDWork ( S , 0 ) ; real_T * o_o_o_B_5_1 = ( real_T * )
ssGetOutputPortSignal ( S , 0 ) ; fzfs2hgelw ( o_o_o_B_5_1 , & ( dw -> rtdw )
) ; } static void mdlPeriodicOutputUpdate ( SimStruct * S , int_T tid ) {
fjvy5vdomkr * dw = ( fjvy5vdomkr * ) ssGetDWork ( S , 0 ) ; real_T const *
i_fe00wjttpr = ( real_T * ) ssGetInputPortSignal ( S , 0 ) ; real_T const *
i_mx1ofag2j4 = ( real_T * ) ssGetInputPortSignal ( S , 1 ) ; real_T const *
i_hdsehxjas3 = ( real_T * ) ssGetInputPortSignal ( S , 2 ) ; real_T *
o_o_o_B_5_1 = ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; if ( tid == 0 )
{ HevP4TransmissionController ( i_fe00wjttpr , i_mx1ofag2j4 , i_hdsehxjas3 ,
...
ssSetInputPortOffsetTime ( S , 2 , 0.0 ) ; if ( ! ssSetNumOutputPorts ( S , 1
...
mr_HevP4TransmissionController_RegisterSimStateChecksum ( S ) ;
...
mr_HevP4TransmissionController_MdlInfoRegFcn ( S ,
"HevP4TransmissionController" , & retVal ) ; if ( ! retVal ) return ; }
#endif
#if SS_SFCN_FOR_SIM
if ( ssSetNumDWork ( S , 1 ) ) { int mdlrefDWTypeId ; ssRegMdlRefDWorkType (
S , & mdlrefDWTypeId ) ; if ( mdlrefDWTypeId == INVALID_DTYPE_ID ) return ;
if ( ! ssSetDataTypeSize ( S , mdlrefDWTypeId , sizeof ( fjvy5vdomkr ) ) )
...
static void mdlSetupRuntimeResources ( SimStruct * S ) { fjvy5vdomkr * dw = (
fjvy5vdomkr * ) ssGetDWork ( S , 0 ) ; void * sysRanPtr = ( NULL ) ; int
sysTid = 0 ; ssGetContextSysRanBCPtr ( S , & sysRanPtr ) ; ssGetContextSysTid
( S , & sysTid ) ; if ( sysTid == CONSTANT_TID ) { sysTid = 0 ; } dqt510qa0h
...
* S , int_T tid ) { fjvy5vdomkr * dw = ( fjvy5vdomkr * ) ssGetDWork ( S , 0 )
; real_T const * i_fe00wjttpr = ( real_T * ) ssGetInputPortSignal ( S , 0 ) ;
real_T const * i_mx1ofag2j4 = ( real_T * ) ssGetInputPortSignal ( S , 1 ) ;
real_T const * i_hdsehxjas3 = ( real_T * ) ssGetInputPortSignal ( S , 2 ) ;
real_T * o_o_o_B_5_1 = ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; if (
tid == PARAMETER_TUNING_TID ) { HevP4TransmissionControllerTID1 ( & ( dw ->
rtb ) ) ; } if ( tid != CONSTANT_TID && tid != PARAMETER_TUNING_TID ) {
HevP4TransmissionController ( i_fe00wjttpr , i_mx1ofag2j4 , i_hdsehxjas3 ,
o_o_o_B_5_1 , & ( dw -> rtb ) , & ( dw -> rtdw ) ) ; } } static void
mdlTerminate ( SimStruct * S ) { fjvy5vdomkr * dw = ( fjvy5vdomkr * )
ssGetDWork ( S , 0 ) ; escpily3xw ( & ( dw -> rtm ) ) ; return ; }
...
mdlrefDW = mr_HevP4TransmissionController_GetDWork ( ssGetDWork ( S , 0 ) ) ;
...
mr_HevP4TransmissionController_SetDWork ( ssGetDWork ( S , 0 ) ,
